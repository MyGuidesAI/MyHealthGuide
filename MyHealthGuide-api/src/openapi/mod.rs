...
#[openapi(
    paths(
        ...
        // Auth endpoints
        MyHealthGuide_domain::auth::auth_info,
        MyHealthGuide_domain::auth::refresh_token,
        MyHealthGuide_domain::auth::logout,
        MyHealthGuide_domain::auth::login,
        
        // OIDC endpoints - note these are partially defined through the routes module
        MyHealthGuide_domain::auth::routes::oidc_routes
    ),
    components(
        schemas(
            // Entities
            ...
            // Auth schemas
            MyHealthGuide_domain::auth::LoginRequest,
            MyHealthGuide_domain::auth::LoginResponse,
            MyHealthGuide_domain::auth::UserInfo,
            MyHealthGuide_domain::auth::Claims,
            
            // OIDC schemas
            MyHealthGuide_domain::auth::routes::OidcCallbackParams,
            MyHealthGuide_domain::auth::routes::OidcLoginResponse,
            MyHealthGuide_domain::auth::routes::OidcErrorResponse
        )
    ),
    tags(
